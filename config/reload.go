...
var knownConfigKeys = []string{
	...
	"helix.starters.observability.tracing.insecure",
	"helix.starters.observability.tracing.headers",
	"helix.starters.observability.tracing.tls.ca-file",
	"helix.starters.observability.tracing.tls.cert-file",
	"helix.starters.observability.tracing.tls.key-file",
	"helix.starters.observability.tracing.tls.server-name",
