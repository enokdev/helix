...
// RegisterComponents registers components for auto-wiring on the next call to
// helix.Run() in zero-config mode.
// Designed to be called from init() functions generated by helix generate.
